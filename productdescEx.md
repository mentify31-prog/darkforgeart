...
- **Tags**: Select `#blackmetal`, `#darkart`, `#metalart`, `#crimson`, `#demonic`, `#skulls`, `#occult`, `#heavymetal`, `#albumcover`, `#bandmerch`

### 📝 Short Description:
> A commanding matte-black steel and crimson emblem edition of the Celestial Demon. Features glowing blood-red oculars, planetary wing sigils, and a metallic infernal skull forged for heavy metal apparel and prints.

### 📖 The Story:
> Born from the brutal aesthetic of death metal, gothic armor, and industrial steel forging. *Obsidian Metal Edition* strips away the street-graffiti colors of the original piece to reveal a hardened, obsidian-and-crimson metallic sigil. The third eye glows with a piercing blood-red light, anchoring Saturnian and planetary seals into a cold, forged iron emblem designed to command authority.

---

## 🛍️ 2. STORE PRODUCTS & PRICING BREAKDOWN

Here is how to set up and price this artwork across **all 4 product types** in **STORE -> Products**:
...
- **File Format**: `PNG`
- **Includes Description**: `4K Wallpaper (3840x2160) + High-Res Transparent Background PNG (300 DPI)`
...
- **Fulfillment Provider**: `Printful` *(or `Printify`)*
- **Description**: `100% Ring-spun Cotton Heavyweight Black Fleece Hoodie. Front-chest obsidian red metal emblem print.`
...
- **Edition Size**: `20`
- **Description**: `Rare 12x16 inch Brushed Metal Print. Limited to 20 hand-numbered copies worldwide. Includes certificate of authenticity.`
...
- **Allowed Uses**: `Metal album artwork, T-shirt merch printing up to 10,000 units, band apparel, and single cover graphics.`


------------

Viewed models.py:1-80

Let's also view `DigitalProduct` in `store/models.py` lines 80-130 to check digital licenses as well:

Viewed models.py:80-130

Awesome! Here is a clear, simple explanation of the **4 Product Types** in your store system so you know exactly which option to choose when adding products to your site.

---

### 🛍️ The 4 Product Types Explained

When you add a new item in **Django Admin** -> **Store** -> **Products**, you choose one of four **Product Types**:

---

### 1. 📁 Digital Download (`digital`)
...
| What are you listing? | Choose Product Type |
|---|---|
| A downloadable high-res image file | **Digital Download** |
| A t-shirt, hoodie, or poster via Printful/Printify | **Physical Product** |
| A rare numbered print (e.g. only 10 copies made) | **Limited Edition** |
| Commercial rights for a music album / clothing brand | **Commercial License** |

-----------

Here are **3 compelling Title, Story, and Description options** crafted specifically for your **DarkForge Art** brand, tailored to the artwork you provided:

---

### Option 1: Gothic & Occult Theme (Recommended for High Art Appeal)

- **Title**: `Demon of the Celestial Spheres` *(or `Alchemical Overlord`)*
- **Slug**: `demon-of-the-celestial-spheres`
- **Style**: `Dark Surrealism` / `Gothic`
- **Tags**: `#skulls`, `#occult`, `#graffiti`, `#alchemical`, `#darkart`
- **Short Description**:
...
### Option 2: Neon Street & Graffiti Theme (Recommended for Apparel & Merch)

- **Title**: `Infernal Sigil` *(or `Graffiti Fiend`)*
- **Slug**: `infernal-sigil`
- **Style**: `Graffiti` / `Street Art`
- **Tags**: `#graffiti`, `#neon`, `#fire`, `#streetart`, `#skullart`
- **Short Description**:
  > Explosive neon graffiti artwork combining vivid color splatters with a dual-skull demon emblem burning in fiery flames. Perfect for dark street apparel and poster prints.
- **Story (Background Narrative)**:
  > *Infernal Sigil* represents the raw energy of urban dark art. High-contrast line art combines with energetic spray splatters, neon purple, cyan, and fiery orange gradients. Designed to stand out on dark hoodies, canvases, and high-resolution wall prints.

---

### Option 3: Cyberpunk / Mystic Theme

- **Title**: `Vanguard of Saturn`
- **Slug**: `vanguard-of-saturn`
- **Style**: `Cyberpunk` / `Mystic`
- **Tags**: `#cyberpunk`, `#saturn`, `#demon`, `#vectorart`, `#darkforge`
- **Short Description**:
  > A stylized cyberpunk emblem featuring glowing violet oculars, planetary sigils, and a flaming demon skull on weathered stone texture.
- **Story (Background Narrative)**:
  > A herald of the dark realm, *Vanguard of Saturn* captures the tension between ancient mystical sigils and modern neon aesthetics. High-definition vector lines contrast against dripping graffiti paints to deliver a bold, commanding visual statement.

---

### 💡 Pricing & Product Configuration Advice for this Piece:
